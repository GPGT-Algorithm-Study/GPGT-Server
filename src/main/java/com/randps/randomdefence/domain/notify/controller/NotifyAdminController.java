...
public class NotifyAdminController {
  ...
  public ResponseEntity<Map<String, String>> deleteAllByReceiver(
    ...
    notifyAdminService.deleteAllByReceiver(receiver);
  ...
  @Auth(role = ADMIN)
  @DeleteMapping("/id")
  public ResponseEntity<Map<String, String>> deleteById(@RequestBody NotifyDeleteRequest request) {
    notifyAdminService.deleteById(request.getId());
